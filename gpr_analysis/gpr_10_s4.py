...
n = 4  # Example: Change this to 1, 2, or 3 depending on the file
percentage = 10  # Example: Change this to 1, 5, or 10 depending on the gamma analysis being performed
...
for filename in tqdm(testIDs):
    ...
    ground_truth=ground_truth[111:150,:,:]
    prediction=prediction[111:150,:,:]
...
dataframe.to_csv(os.path.join(path, f'gamma_results_{percentage}_section_{n}.csv'), index=False)
